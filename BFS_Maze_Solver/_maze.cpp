...
void explore_cell(Location, Location, int, int, bool**);
...
int maze_search(char** maze, int rows, int cols)
{
  ...
  while (!searchQueue.is_empty())
  {
    ...
    if (!visited[currentLocation.row][currentLocation.col])
    {
      ...
      void explore_cell(currentLocation.row-1, currentLocation.col, int rows, int cols, bool** visited);
      void explore_cell(currentLocation.row, currentLocation.col-1, int rows, int cols, bool** visited);
      void explore_cell(currentLocation.row+1, currentLocation.col, int rows, int cols, bool** visited);
      void explore_cell(currentLocation.row, currentLocation.col+1, int rows, int cols, bool** visited);
