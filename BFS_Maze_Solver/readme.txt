...
: after extracting it from the the queue.
...
: Yes. I ended up setting up two different lenght paths and it did find
the shortest one.
...
: It took a bit to understand the struct based 2D array and the propper
use of it. I spent most of the time on the predecessor part of the program.
