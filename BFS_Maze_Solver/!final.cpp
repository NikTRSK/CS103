    ...
    if (!visited[currentLocation.row][currentLocation.col])
    {
      ...
      if (currentLocation.row-1 >= 0)  // check for out of bounds
      {
              ...
              && (!visited[currentLocation.row-1][currentLocation.col]) )
        {
          ...
          predecessor[neighbourNorth.row][neighbourNorth.col].row 
            = currentLocation.row;
          predecessor[neighbourNorth.row][neighbourNorth.col].col 
            = currentLocation.col;
        }
      }
      ...
      if ((currentLocation.col-1) >= 0)  // check for out of bounds
      {
              ...
              && (!visited[currentLocation.row][currentLocation.col-1]) )
        {
          ...
          predecessor[neighbourWest.row][neighbourWest.col].row 
            = currentLocation.row;
          predecessor[neighbourWest.row][neighbourWest.col].col 
            = currentLocation.col;
        }
      }
    ...
    // check if the location is open and not visited
      ...
      if ((currentLocation.row+1) < rows)  // check for out of bounds
      {
              ...
              && (!visited[currentLocation.row+1][currentLocation.col]) )
        {
          ...
          predecessor[neighbourSouth.row][neighbourSouth.col].row 
            = currentLocation.row;
          predecessor[neighbourSouth.row][neighbourSouth.col].col 
            = currentLocation.col;
        }
      }
      ...
      if ((currentLocation.col+1) < cols)  // check for out of bounds
      {
              ...
              && (!visited[currentLocation.row][currentLocation.col+1]) )
        {
          ...
          predecessor[neighbourEast.row][neighbourEast.col].row 
            = currentLocation.row;
          predecessor[neighbourEast.row][neighbourEast.col].col 
            = currentLocation.col;
        }
      }
    }
